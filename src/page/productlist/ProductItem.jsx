  ...
  return (
    <div className='relative mt-4 bg-red-300 rounded shadow-md shadow-red-200 hover:scale-105 transition'>
      ...
      <div className='flex justify-around my-2'>
        <Link to={link}>
          <button className='text-xl rounded-md text-center w-40 text-white px-3 py-2 bg-cyan-500 uppercase' >Detail</button>
        </Link>
        <button className='text-xl rounded-md text-center w-32 text-white px-3 py-2 bg-cyan-500 uppercase' onClick={handleAddToCart} >add to cart</button>
      </div>
    </div>
  )
}
